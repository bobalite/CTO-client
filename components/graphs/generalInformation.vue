...
async function fetchReports_Details_Bars_Annual() {
  try {
      ...
      if (Number.isNaN(value)) continue;
        ...
        switch (row.indicator_no) {
            ...
            case '46.2':
                ...
                break;
            case '46.2.1':
                pop_46_2_1[idx] += value;
                break;
            case '46.2.2':
                pop_46_2_2[idx] += value;
                break;
            case '46.2.3':
                pop_46_2_3[idx] += value;
                break;
            case '46.2.4':
                pop_46_2_4[idx] += value;
                break;
            case '46.2.5':
                pop_46_2_5[idx] += value;
                break;
            case '46.2.6':
                pop_46_2_6[idx] += value;
                break;
            case '46.2.7':
                pop_46_2_7[idx] += value;
                break;
            case '46.2.8':
                pop_46_2_8[idx] += value;
                break;
            case '46.2.9':
                pop_46_2_9[idx] += value;
                break;
            case '46.2.10':
                pop_46_2_10[idx] += value;
                break;
            case '46.2.11':
                pop_46_2_11[idx] += value;
                break;
            case '46.2.12':
                pop_46_2_12[idx] += value;
                break;
            case '46.2.13':
                pop_46_2_13[idx] += value;
                break;
            case '46.2.14':
                pop_46_2_14[idx] += value;
                break;
            case '46.2.15':
                pop_46_2_15[idx] += value;
                break;
            case '46.2.16':
                pop_46_2_16[idx] += value;
                break;
            case '46.2.17':
                pop_46_2_17[idx] += value;
                break;
            case '46.2.18':
                pop_46_2_18[idx] += value;
                break;

            case '47.1':
                pwd_pop_47_1[idx] += value;
                break;
            case '47.1.1':
                pwd_pop_47_1_1[idx] += value;
                break;
            case '47.1.2':
                pwd_pop_47_1_2[idx] += value;
                break;
            case '47.2':
                pwd_pop_47_2[idx] += value;
                break;
                
            case '48.1':
                tribe_pop_48_1[idx] += value;
                break;
            case '48.2':
                tribe_pop_48_2[idx] += value;
                break;
            case '48.3':
                tribe_pop_48_3[idx] += value;
                break;
            case '48.4':
                tribe_pop_48_4[idx] += value;
                break;
            case '48.5':
                tribe_pop_48_5[idx] += value;
                break;
            case '48.6':
                tribe_pop_48_6[idx] += value;
                break;
            case '48.7':
                tribe_pop_48_7[idx] += value;
                break;
            case '48.8':
                tribe_pop_48_8[idx] += value;
                break;
            case '48.9':
                tribe_pop_48_9[idx] += value;
                break;
            case '48.10':
                tribe_pop_48_10[idx] += value;
                break;
            case '48.11':
                tribe_pop_48_11[idx] += value;
                break;
            case '48.12':
                tribe_pop_48_12[idx] += value;
                break;
            ...
            case '48.12':
                ...
                break;
            case '48.13':
                tribe_pop_48_13[idx] += value;
                break;
            case '48.14':
                tribe_pop_48_14[idx] += value;
                break;
            case '48.15':
                tribe_pop_48_15[idx] += value;
                break;
            case '48.16':
                tribe_pop_48_16[idx] += value;
                break;
            case '48.17':
                tribe_pop_48_17[idx] += value;
                break;
            case '48.18':
                tribe_pop_48_18[idx] += value;
                break;
            case '48.19':
                tribe_pop_48_19[idx] += value;
                break;
            case '48.20':
                tribe_pop_48_20[idx] += value;
                break;
            case '48.21':
                tribe_pop_48_21[idx] += value;
                break;
            case '48.22':
                tribe_pop_48_22[idx] += value;
                break;
            case '48.23':
                tribe_pop_48_23[idx] += value;
                break;
            
            case '49.21':    
                civreg_49_1[idx] += value;
                break;
            case '49.22':    
                civreg_49_2[idx] += value;
                break;
            case '49.23':    
                civreg_49_3[idx] += value;
                break;
            case '49.24':    
                civreg_49_4[idx] += value;
                break;
            case '49.25':    
                civreg_49_5[idx] += value;
                break;            
            default:
    ...
    state.pop = [
      ...
      {
        name: 'Total Population of Children, by age:',
        data: pop_46_2,
      },
      {
        name: '< 1yr old',
    ...
    state.pwd = [
      {
         name: 'Total Population of Persons With Disabilities (PWDs)',
        data: pwd_pop_47_1,

      },
       {
         name: 'Total Population of Adult PWDs (18 years old and above)',
        data: pwd_pop_47_1_1,

      },
       {
         name: 'Total Population of Children With Disabilities (17 years old and below)',
        data: pwd_pop_47_1_2,

      },
       {
         name: 'Total Number of Child Laborers (17 years old and below)',
        data: pwd_pop_47_2,
      },
    ...
    state.tribe_pop = [
      {
        name: 'Total Population of Children Belong to IP/Moro Sector, by Ethnicity:',
        data: tribe_pop_48_1,
      },
       {
        name: 'Total Population of Ata Tribe',
        data: tribe_pop_48_2,
      }
      ,
       {
        name: 'Total Population of Children Belonging to Ata Tribe (17 years old and below only)',
        data: tribe_pop_48_3,
      }
      ,
       {
        name: 'Total Population of Bagobo-Tagabawa Tribe',
        data: tribe_pop_48_4,
      }
      ,
       {
        name: 'Total Population of Children Belonging to Bagobo-Tagabawa Tribe (17 years old and below only)',
        data: tribe_pop_48_5,
      },


       {
        name: 'Total Population of Bagobo-Klata Tribe',
        data: tribe_pop_48_6,
      }
      ,
       {
        name: 'Total Population of Children Belonging to Bagobo-Klata Tribe (17 years old and below only)',
        data: tribe_pop_48_7,
      },


       {
        name: 'Total Population of Matigsalug Tribe',
        data: tribe_pop_48_8,
      }
      ,
       {
        name: 'Total Population of Children Belonging to Matigsalug Tribe (17 years old and below only)',
        data: tribe_pop_48_9,
      }

      ,
       {
        name: 'Total Population of Obu-Manuvu Tribe',
        data: tribe_pop_48_10,
      }
      ,
       {
        name: 'Total Population of Children Belonging to Obu-Manuvu Tribe (17 years old and below only)',
        data: tribe_pop_48_11,
      }


      ,
       {
        name: 'Total Population of Maguindanaon Tribe',
        data: tribe_pop_48_12,
      }
      ,
       {
        name: 'Total Population of Children Belonging to Maguindanaon Tribe (17 years old and below only)',
        data: tribe_pop_48_13,
      }

      ,
       {
        name: 'Total Population of Iranun Tribe',
        data: tribe_pop_48_14,
      }
      ,
       {
        name: 'Total Population of Children Belonging to Iranun Tribe (17 years old and below only)',
        data: tribe_pop_48_15,
      }

      ,
       {
        name: 'Total Population of Kagan Tribe',
        data: tribe_pop_48_16,
      }
      ,
       {
        name: 'Total Population of Children Belonging to Kagan Tribe (17 years old and below only)',
        data: tribe_pop_48_17,
      }

      ,
       {
        name: 'Total Population of Maranao Tribe',
        data: tribe_pop_48_18,
      }
      ,
       {
        name: 'Total Population of Children Belonging to Maranao Tribe (17 years old and below only)',
        data: tribe_pop_48_19,
      }

      ,
       {
        name: 'Total Population of Sama Tribe',
        data: tribe_pop_48_20,
      }
      ,
       {
        name: 'Total Population of Children Belonging to Sama Tribe (17 years old and below only)',
        data: tribe_pop_48_21,
      }

      ,
       {
        name: 'Total Population of Tausug Tribe',
        data: tribe_pop_48_22,
      }
      ,
       {
        name: 'Total Population of Children Belonging to Tausug Tribe (17 years old and below only)',
        data: tribe_pop_48_23,
      }
     ...
     state.civreg = [
      {
        name: 'Total number of children registered at-birth (17 years old and below only)',
        data: civreg_49_1,
      },
       {
        name: 'Total number of Moro children registered at-birth (17 years old and below only)',
        data: civreg_49_2,
      }
      ,
       {
        name: 'Total number of children belonging to IP sector registered at-birth (17 years old and below only)',
        data: civreg_49_3,
      }
      ,
       {
        name: 'Total number of birth registration facilitated in "Sa Paaralan Ko, Pwede Nang Magrehistro" (SCRA) (17 years old and below only)',
        data: civreg_49_4,
      }
      ,
       {
        name: 'Total number of birth registration facilitated thru BCRA (17 years old and below only)',
        data: civreg_49_5,
      },
