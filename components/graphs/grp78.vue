        ...
        if (response.data) {
             ...
             if (response) {
                ...
                for (const c in state.report_details.data) {
                    ...
                    if (state.report_details.data[c].sequence_header == '6.1.4.9.1') {
                    ...
                    } else if (state.report_details.data[c].sequence_header == '6.1.4.9.2') {
                    ...
                    } else if (state.report_details.data[c].sequence_header == '6.1.4.9.3') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.9.4') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.9.5') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.9.6') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.9.7') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.9.8') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.9.9') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.9.10') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.9.11') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.9.12') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.9.13') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.9.14') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.9.15') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.9.16') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.9.17') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.9.18') {
