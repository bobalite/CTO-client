<template>
    <div :class=props.class >
        <div >
        <h3 class="text-lg font-bold border-1 border-solid border-blue-900  rounded-xl ">Group 78. {{props.displaytext}}</h3>
        <apexchart="bar" height="400" width="100%" :options="state.populationHoriOptions"
...
async function fetchReports_Details_Actuals() { // main fetching function for actuals
    try {
        ...
        for (const c in state.report_details.data) {
            ...
            if (state.report_details.data[c].sequence_header == '6.1.4.9.1' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.9.2' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.9.3' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.9.4' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.9.5' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.9.6' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.9.7' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.9.8' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.9.9' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.9.10' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.9.11' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.9.12' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.9.13' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.9.14' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.9.15' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.9.16' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.9.17' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.9.18' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
