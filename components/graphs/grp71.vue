        ...
        if (response.data) {
             ...
             if (response) {
                ...
                for (const c in state.report_details.data) {
                    ...
                    if (state.report_details.data[c].sequence_header == '6.1.4.2.1') {
                    ...
                    } else if (state.report_details.data[c].sequence_header == '6.1.4.2.2') {
                    ...
                    } else if (state.report_details.data[c].sequence_header == '6.1.4.2.3') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.2.4') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.2.5') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.2.6') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.2.7') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.2.8') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.2.9') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.2.10') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.2.11') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.2.12') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.2.13') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.2.14') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.2.15') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.2.16') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.2.17') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.2.18') {
