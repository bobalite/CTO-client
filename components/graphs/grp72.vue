        ...
        if (response.data) {
             ...
             if (response) {
                ...
                for (const c in state.report_details.data) {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.3.10') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.3.11') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.3.12') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.3.13') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.3.14') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.3.15') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.3.16') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.3.17') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.3.18') {
