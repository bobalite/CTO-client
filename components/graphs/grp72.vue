<template>
    <div :class=props.class >
        <div >
        <h3 class="text-lg font-bold border-1 border-solid border-blue-900  rounded-xl ">Group 72. {{props.displaytext}}</h3>
...
async function fetchReports_Details_Actuals() { // main fetching function for actuals
    try {
        ...
        for (const c in state.report_details.data) {
            ...
            if (state.report_details.data[c].sequence_header == '6.1.4.3.1' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.3.2' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.3.3' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.3.4' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.3.5' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.3.6' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.3.7' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.3.8' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.3.9' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.3.10' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.3.11'  && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.3.12'  && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.3.13'  && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.3.14'  && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.3.15' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.3.16' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.3.17' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.3.18'  && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
