        ...
        if (response.data) {
             ...
             if (response) {
                ...
                for (const c in state.report_details.data) {
                    ...
                    if (state.report_details.data[c].sequence_header == '6.1.4.3.1') {
                    ...
                    } else if (state.report_details.data[c].sequence_header == '6.1.4.3.2') {
                    ...
                    } else if (state.report_details.data[c].sequence_header == '6.1.4.3.3') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.3.4') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.3.5') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.3.6') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.3.7') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.3.8') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.3.9') {
