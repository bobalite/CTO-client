        ...
        if (response.data) {
             ...
             if (response) {
                ...
                for (const c in state.report_details.data) {
                    ...
                    if (state.report_details.data[c].sequence_header == '6.1.4.4.1') {
                    ...
                    } else if (state.report_details.data[c].sequence_header == '6.1.4.4.2') {
                    ...
                    } else if (state.report_details.data[c].sequence_header == '6.1.4.4.3') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.4.4') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.4.5') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.4.6') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.4.7') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.4.8') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.4.9') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.4.10') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.4.11') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.4.12') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.4.13') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.4.14') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.4.15') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.4.16') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.4.17') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.4.18') {
