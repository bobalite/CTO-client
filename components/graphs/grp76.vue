        ...
        if (response.data) {
             ...
             if (response) {
                ...
                for (const c in state.report_details.data) {
                    ...
                    if (state.report_details.data[c].sequence_header == '6.1.4.7.1') {
                    ...
                    } else if (state.report_details.data[c].sequence_header == '6.1.4.7.2') {
                    ...
                    } else if (state.report_details.data[c].sequence_header == '6.1.4.7.3') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.7.4') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.7.5') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.7.6') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.7.7') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.7.8') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.7.9') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.7.10') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.7.11') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.7.12') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.7.13') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.7.14') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.7.15') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.7.16') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.7.17') {
                    ...
                    }else if (state.report_details.data[c].sequence_header == '6.1.4.7.18') {
