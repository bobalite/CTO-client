<template>
    <div :class=props.class >
        <div >
        <h3 class="text-lg font-bold border-1 border-solid border-blue-900  rounded-xl ">Group 76. {{props.displaytext}}</h3>
...
async function fetchReports_Details_Actuals() { // main fetching function for actuals
    try {
        ...
        for (const c in state.report_details.data) {
            ...
            if (state.report_details.data[c].sequence_header == '6.1.4.7.1' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.7.2' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.7.3' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.7.4' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.7.5' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.7.6' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.7.7' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.7.8' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.7.9' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.7.10' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.7.11' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.7.12' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.7.13' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.7.14' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.7.15' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.7.16' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.7.17' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.7.18' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
