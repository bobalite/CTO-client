...
async function fetchReports_Details_Actuals() { // main fetching function for actuals
    try {
        ...
        for (const c in state.report_details.data) {
            if (state.report_details.data[c].sequence_header == '6.1.4.6.1' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.6.2' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.6.3' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.6.4' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.6.5' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.6.6' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.6.7' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.6.8' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.6.9' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.6.10' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.6.11' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.6.12' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.6.13' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.6.14' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.6.15' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.6.16' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.6.17' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
            ...
            } else if (state.report_details.data[c].sequence_header == '6.1.4.6.18' && state.report_details.data[c].entry_type == 'Actual' && state.report_details.data[c].report_year_id == props.report_year) {
