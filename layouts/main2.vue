                            ...
                            <ul role="list" class="-mx-2 space-y-1">
                              ...
                              <nav class="flex flex-1 flex-col">
                                    <ul role="list" class="flex flex-1 flex-col gap-y-4">
                                        <SidebarMenu v-for="(item, key) in navigation" :key="key" :name="item.name"
                                        :link="item.link" :icons="item.icons" />
                                    </ul>
                              </nav>
                        ...
                        <Menu as="div" class="relative">
                            <MenuButton class="-m-1.5 flex items-center p-1.5">
                                ...
                                <span class="hidden lg:flex lg:items-center">
                                    <span class="ml-4 text-sm font-semibold leading-6 text-gray-900"
                                        aria-hidden="true">{{ userStore.getUser.firstname }} {{
                            ...
                            <transition enter-active-class="transition ease-out duration-100"
                                ...
                                <MenuItems
                                    ...
                                    <MenuItem>
                                    <NuxtLink @click="logout" class="block px-3 py-1 text-sm leading-6 text-gray-900">
                                        Logout
                                    </NuxtLink>
                                    </MenuItem>
                                </MenuItems>
...
const navigation = [
    { name: 'Dashboard', link: '/graphs', icons: '1', current: true },
    { name: 'Data Entry', link: '/', icons: '2', current: false },
    { name: 'Projects', link: '/', icons: '3', current: false },
    { name: 'Calendar', link: '/', icons: '4', current: false },
    { name: 'Documents', link: '/', icons: '5', current: false },
    { name: 'Reports', link: '/', icons: '6', current: false },
]
