...
<template>
    ...
    <div>
        ...
        <div class="border-b border-gray-200 bg-white rounded-lg shadow-sm ">
            ...
            <apexchart type="bar" height="300" width="50%" :options="state.populationHoriOptions"
        ...
        <!-- <div class="border-b border-gray-200 bg-white rounded-lg shadow-sm">
            ...
            <apexchart type="bar" height="800" width="50%" :options="state.developmentOptions"
        ...
        <div class="border-b border-gray-200 bg-white rounded-lg shadow-sm">
            ...
            <apexchart type="bar" height="300" width="50%" :options="state.ProtectionOptions"
        ...
        <div class="border-b border-gray-200 bg-white rounded-lg shadow-sm">
            ...
            <apexchart type="bar" height="1000" width="50%" :options="state.populationHoriOptions"
        ...
        <!-- <div class="border-b border-gray-200 bg-white rounded-lg shadow-sm">
            ...
            <apexchart type="area" height="375" width="100%" :options="state.populationAreaOptions"
        ...
        <div class="border-b border-gray-200 bg-white rounded-lg shadow-sm">
            ...
            <apexchart type="bar" height="1000" width="100%" :options="state.populationHoriOptions"
        ...
        <!-- <div class="grid grid-cols-1 sm:grid-cols-2 mt-8 gap-y-4 sm:gap-x-4">
            <div class="border-b border-gray-200 bg-white rounded-lg shadow-sm">
                ...
                <div class="mt-4">
                    <apexchart type="bar" height="2000" width="25%" :options="state.populationHoriOptions"
                    :series="state.populationHoriOptions.series" />
                </div>
            </div>
        </div> -->
