    ...
    <template v-if="state.selected_graph_type == 'none'">
      ...
      <template v-for="selected_right in state.Selected_Rights_entry_config_values">
        ...
        <template v-if="selected_right.tier_level == 1">
          <PrintRowheader v-if="selected_right.tier_level == 1" 
          :group_number="selected_right.group"
          :group_header="selected_right.group_header" 
          :datasource="selected_right.agency_id"
          :is_annual="selected_right.is_annual" />

          <PrintRow 
          :indicator="selected_right.description" 
          :male=1 
          :female=1 
          :total=1
          />
        ...
        <PrintRow v-if="selected_right.tier_level != 1" :indicator="selected_right.description"
          :male="selected_right.male" 
          :female="selected_right.female" 
          :total="selected_right.total"
           />
