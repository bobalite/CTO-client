<template>
  ...
  <div class="report-print-root">
    ...
    <!-- CATEGORY -->
    <template v-for="(category, catIndex) in categories" :key="category.id">
      <div
        :class="[
          'print-category-page',
          { 'print-category-new-page': catIndex > 0 }
        ]"
      >
            ...
            >
              ...
              <div class="space-y-3">
                <template v-for="group in (subcategory.indicator_groups || [])" :key="group.id">
                  <div class="border border-gray-300 rounded p-2 print-group">
                    <div class="font-semibold text-sm print:text-xs mb-2 print-group-title">
                    ...
                    <div class="print-group-content">
                      ...
                      >
                        ...
                        <GridCell
                          class="sm:col-span-6 text-center text-xs border-l border-b"
                          displaytext="INDICATOR"
                        />
                        <GridCell
                          class="sm:col-span-2 text-center text-xs border-l border-b"
                          displaytext="MALE"
                        />
                        <GridCell
                          class="sm:col-span-2 text-center text-xs border-l border-b"
                        ...
                        />
                        <GridCell
                          class="sm:col-span-3 text-center text-xs border-l border-b"
                          displaytext="REMARKS"
                        />
                        <GridCell
